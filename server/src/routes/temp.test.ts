...
describe('GET /api/v1/temp/data', () => {
  it('returns 200', async () => {
    const res = await request(app).get('/api/v1/temp/data').set(V1);
...
describe('GET /api/v1/temp/error', () => {
  it('returns 500', async () => {
    const res = await request(app).get('/api/v1/temp/error').set(V1);
