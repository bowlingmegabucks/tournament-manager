...
{
    private TournamentManager.Registrations.CreateRegistration.Validator _validator;

    [OneTimeSetUp]
    public void SetUp()
        => _validator = new TournamentManager.Registrations.CreateRegistration.Validator();

    [Test]
    public void Bowler_HasBowlerValidator()
        => _validator.ShouldHaveChildValidator(registration => registration.Bowler, typeof(TournamentManager.Bowlers.Validator));
    ...
    {
        var squads = Enumerable.Empty<TournamentManager.Models.Squad>();
    ...
    {
        var squads = Enumerable.Repeat(new TournamentManager.Models.Squad(), count);
    ...
    {
        var sweepers = Enumerable.Repeat(new TournamentManager.Models.Sweeper { Id = SquadId.New() }, count);
    ...
    {
        var sweepers = Enumerable.Repeat(new TournamentManager.Models.Sweeper { Id = SquadId.New() }, 3);
    ...
    {
        var squads = Enumerable.Repeat(new TournamentManager.Models.Squad(), 2);
        ...
        var bowler = new TournamentManager.Models.Bowler
        {
            Name = new TournamentManager.Models.PersonName { First = "Ashlie", MiddleInitial = "S", Last = "Kipperman" },
