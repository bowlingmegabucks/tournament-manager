...
internal sealed class DataLayer
{
    ...
    {
        _repository.Setup(repository => repository.Retrieve(It.IsAny<TournamentId>())).Returns(Array.Empty<TournamentManager.Database.Entities.TournamentSquad>().BuildMock());
