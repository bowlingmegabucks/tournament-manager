...
internal sealed class PersonNameValidator
{
    ...
    private IValidator<TournamentManager.Models.PersonName> _validator;

    [OneTimeSetUp]
    public void SetUp()
        => _validator = new TournamentManager.Bowlers.PersonNameValidator();

    [Test]
    public void First_NullWhitespace_HasValidatorError([Values(null, "", " ")] string First)
    {
        var name = new TournamentManager.Models.PersonName { First = First };
    ...
    {
        var name = new TournamentManager.Models.PersonName { First = "John" };
    ...
    {
        var name = new TournamentManager.Models.PersonName { MiddleInitial = middleInitial };
    ...
    {
        var name = new TournamentManager.Models.PersonName { MiddleInitial = "J" };
    ...
    {
        var name = new TournamentManager.Models.PersonName { MiddleInitial = new string('J', length) };
    ...
    {
        var name = new TournamentManager.Models.PersonName { Last = Last };
    ...
    {
        var name = new TournamentManager.Models.PersonName { Last = "Doe" };
