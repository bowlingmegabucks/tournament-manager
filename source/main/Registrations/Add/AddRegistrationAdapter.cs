...
internal class Adapter : IAdapter
{
    ...
    public RegistrationId? Execute(Bowlers.Add.IViewModel bowler, NortheastMegabuck.Divisions.Id divisionId, IEnumerable<SquadId> squads, IEnumerable<SquadId> sweepers, bool superSweeper, int? average)
...
internal interface IAdapter
{
    ...
    RegistrationId? Execute(Bowlers.Add.IViewModel bowler, NortheastMegabuck.Divisions.Id divisionId, IEnumerable<SquadId> squads, IEnumerable<SquadId> sweepers, bool superSweeper, int? average);
}