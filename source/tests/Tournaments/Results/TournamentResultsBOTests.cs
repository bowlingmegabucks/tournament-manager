...
{
    private Mock<BowlingMegabucks.TournamentManager.Tournaments.Results.ICalculator> _calculator;
    private Mock<BowlingMegabucks.TournamentManager.Squads.Results.IBusinessLogic> _retrieveSquadResults;
    private Mock<BowlingMegabucks.TournamentManager.Tournaments.Retrieve.IBusinessLogic> _retrieveTournament;

    private BowlingMegabucks.TournamentManager.Tournaments.Results.BusinessLogic _businessLogic;

    [SetUp]
    public void SetUp()
    {
        _calculator = new Mock<BowlingMegabucks.TournamentManager.Tournaments.Results.ICalculator>();
        _retrieveSquadResults = new Mock<BowlingMegabucks.TournamentManager.Squads.Results.IBusinessLogic>();
        _retrieveTournament = new Mock<BowlingMegabucks.TournamentManager.Tournaments.Retrieve.IBusinessLogic>();

        _businessLogic = new BowlingMegabucks.TournamentManager.Tournaments.Results.BusinessLogic(_calculator.Object, _retrieveSquadResults.Object, _retrieveTournament.Object);
    }
    ...
    public async Task ExecuteAsync_RetrieveTournamentHasError_ErrorFlow()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            _calculator.Verify(calculator => calculator.Execute(It.IsAny<DivisionId>(), It.IsAny<ICollection<BowlingMegabucks.TournamentManager.Models.SquadResult>>(), It.IsAny<decimal>()), Times.Never);
        });
    }
    ...
    {
        var division1 = new BowlingMegabucks.TournamentManager.Models.Division();
        var division2 = new BowlingMegabucks.TournamentManager.Models.Division();
        ...
        Assert.Multiple(() =>
        {
            _calculator.Verify(calculator => calculator.Execute(It.IsAny<DivisionId>(), It.IsAny<ICollection<BowlingMegabucks.TournamentManager.Models.SquadResult>>(), It.IsAny<decimal>()), Times.Exactly(2));

            _calculator.Verify(calculator => calculator.Execute(division1.Id, It.Is<ICollection<BowlingMegabucks.TournamentManager.Models.SquadResult>>(squadResults => squadResults.Single() == squadResult1), 5), Times.Once);
            _calculator.Verify(calculator => calculator.Execute(division2.Id, It.Is<ICollection<BowlingMegabucks.TournamentManager.Models.SquadResult>>(squadResults => squadResults.Single() == squadResult2), 5), Times.Once);
        });
    }
    ...
    public async Task ExecuteAsync_RetrieveTournamentNoError_RetrieveSquadResultsNoError_Calculator_ReturnsAtLargeModel()
    {
        ...
        {
            Division = division1,
            AdvancingScores = Enumerable.Repeat(new BowlingMegabucks.TournamentManager.Models.BowlerSquadScore(200), 5)
        };
        var squadResult2 = new BowlingMegabucks.TournamentManager.Models.SquadResult
        {
            Division = division2,
            AdvancingScores = Enumerable.Repeat(new BowlingMegabucks.TournamentManager.Models.BowlerSquadScore(200), 6)
        };
        ...
        var division1AtLarge = new BowlingMegabucks.TournamentManager.Models.AtLargeResults { DivisionId = division1.Id };
        var division2AtLarge = new BowlingMegabucks.TournamentManager.Models.AtLargeResults { DivisionId = division2.Id };

        _calculator.Setup(calculator => calculator.Execute(division1.Id, It.IsAny<ICollection<BowlingMegabucks.TournamentManager.Models.SquadResult>>(), It.IsAny<decimal>())).Returns(division1AtLarge);
        _calculator.Setup(calculator => calculator.Execute(division2.Id, It.IsAny<ICollection<BowlingMegabucks.TournamentManager.Models.SquadResult>>(), It.IsAny<decimal>())).Returns(division2AtLarge);
