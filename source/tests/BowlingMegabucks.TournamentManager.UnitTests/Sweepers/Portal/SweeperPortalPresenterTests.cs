...
namespace BowlingMegabucks.TournamentManager.UnitTests.Sweepers.Portal;

[TestFixture]
internal sealed class Presenter
{
    private Mock<TournamentManager.Sweepers.Portal.IView> _view;
    private Mock<TournamentManager.Sweepers.Retrieve.IAdapter> _retrieveAdapter;
    private Mock<TournamentManager.Sweepers.Complete.IAdapter> _completeAdapter;

    private TournamentManager.Sweepers.Portal.Presenter _presenter;

    [SetUp]
    public void SetUp()
    {
        _view = new Mock<TournamentManager.Sweepers.Portal.IView>();
        _retrieveAdapter = new Mock<TournamentManager.Sweepers.Retrieve.IAdapter>();
        _completeAdapter = new Mock<TournamentManager.Sweepers.Complete.IAdapter>();

        _presenter = new TournamentManager.Sweepers.Portal.Presenter(_view.Object, _retrieveAdapter.Object, _completeAdapter.Object);
    }
