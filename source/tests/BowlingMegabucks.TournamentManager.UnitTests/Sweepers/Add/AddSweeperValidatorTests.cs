...
{
    private IValidator<TournamentManager.Models.Sweeper> _validator;

    [SetUp]
    public void SetUp()
        => _validator = new TournamentManager.Sweepers.Add.Validator();
    ...
    {
        var squad = new TournamentManager.Models.Sweeper
        {
