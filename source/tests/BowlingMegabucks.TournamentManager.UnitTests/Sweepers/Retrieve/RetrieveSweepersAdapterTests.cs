...
{
    private Mock<TournamentManager.Sweepers.Retrieve.IBusinessLogic> _businessLogic;

    private TournamentManager.Sweepers.Retrieve.Adapter _adapter;

    [SetUp]
    public void SetUp()
    {
        _businessLogic = new Mock<TournamentManager.Sweepers.Retrieve.IBusinessLogic>();

        _adapter = new TournamentManager.Sweepers.Retrieve.Adapter(_businessLogic.Object);
    }
    ...
    {
        var sweeper1 = new TournamentManager.Models.Sweeper { MaxPerPair = 1 };
        var sweeper2 = new TournamentManager.Models.Sweeper { MaxPerPair = 2 };
    ...
    {
        var squad = new TournamentManager.Models.Sweeper { MaxPerPair = 1 };
