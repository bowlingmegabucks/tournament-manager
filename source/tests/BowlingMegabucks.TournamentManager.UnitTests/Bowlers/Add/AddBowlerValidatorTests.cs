...
namespace BowlingMegabucks.TournamentManager.UnitTests.Bowlers.Add;

[TestFixture]
internal sealed class Validator
{
    private IValidator<TournamentManager.Models.Bowler> _validator;

    [OneTimeSetUp]
    public void SetUp()
        => _validator = new TournamentManager.Bowlers.Add.Validator();

    [Test]
    public void Name_HasPersonNameValidator()
        => _validator.ShouldHaveChildValidator(bowler => bowler.Name, typeof(TournamentManager.Bowlers.PersonNameValidator));
    ...
    {
        var bowler = new TournamentManager.Models.Bowler { SocialSecurityNumber = ssn.Encrypt() };
