...
{
    private TournamentManager.Tournaments.IEntityMapper _mapper;

    [OneTimeSetUp]
    public void OneTimeSetUp()
        => _mapper = new TournamentManager.Tournaments.EntityMapper();
    ...
    public void Execute_IdMapped()
    {
        ...
        var model = new TournamentManager.Models.Tournament { Id = id };
    ...
    public void Execute_NameMapped()
    {
        ...
        var model = new TournamentManager.Models.Tournament { Name = name };
    ...
    public void Execute_StartMapped()
    {
        ...
        var model = new TournamentManager.Models.Tournament { Start = startDate };
    ...
    public void Execute_EndMapped()
    {
        ...
        var model = new TournamentManager.Models.Tournament { End = endDate };
    ...
    public void Execute_EntryFeeMapped()
    {
        ...
        var model = new TournamentManager.Models.Tournament { EntryFee = entryFee };
    ...
    public void Execute_GamesMapped()
    {
        ...
        var model = new TournamentManager.Models.Tournament { Games = games };
    ...
    public void Execute_FinalsRatioMapped()
    {
        ...
        var model = new TournamentManager.Models.Tournament { FinalsRatio = finalsRatio };
    ...
    public void Execute_CashRatioMapped()
    {
        ...
        var model = new TournamentManager.Models.Tournament { CashRatio = cashRatio };
    ...
    public void Execute_BowlingCenterMapped()
    {
        ...
        var model = new TournamentManager.Models.Tournament { BowlingCenter = bowlingCenter };
    ...
    {
        var model = new TournamentManager.Models.Tournament { Completed = completed };
    ...
    {
        var model = new TournamentManager.Models.Tournament { SuperSweeperCashRatio = 1.2m };
