...
internal sealed class BusinessLogic
{
    ...
    public async Task ExecuteAsync_GetTournamentBOExecute_CalledCorrectly()
    {
        ...
        _getTournamentBO.Verify(getTournamentBO => getTournamentBO.HandleAsync(It.Is<GetRegistrationByIdQuery>(q => q.Id == squad.TournamentId), cancellationToken), Times.Once);
    }
    ...
    public async Task ExecuteAsync_GetTournamentBOHasError_ErrorFlow()
    {
        ...
        _getTournamentBO.Setup(getTournamentBO => getTournamentBO.HandleAsync(It.IsAny<GetRegistrationByIdQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(error);
