...
{
    private Mock<TournamentManager.Squads.Results.IBusinessLogic> _businessLogic;

    private TournamentManager.Squads.Results.Adapter _adapter;

    [SetUp]
    public void SetUp()
    {
        _businessLogic = new Mock<TournamentManager.Squads.Results.IBusinessLogic>();

        _adapter = new TournamentManager.Squads.Results.Adapter(_businessLogic.Object);
    }
    ...
    {
        var squad = new TournamentManager.Models.Squad { Id = SquadId.New(), Date = new DateTime(2000, 1, 2, 9, 30, 0, DateTimeKind.Unspecified) };

        var division1 = new TournamentManager.Models.Division { Name = "division1" };
        var division2 = new TournamentManager.Models.Division { Name = "division2" };

        var division1AdvancerScore = new TournamentManager.Models.BowlerSquadScore(200, 200, 200)
        {
            SquadId = squad.Id,
            Division = division1,
            Bowler = new TournamentManager.Models.Bowler { Name = new TournamentManager.Models.PersonName { First = "division1AdvancerScore" } }
        };

        var division1CasherScore1 = new TournamentManager.Models.BowlerSquadScore(199, 199, 199)
        {
            SquadId = squad.Id,
            Division = division1,
            Bowler = new TournamentManager.Models.Bowler { Name = new TournamentManager.Models.PersonName { First = "division1CasherScore1" } }
        };

        var division1CasherScore2 = new TournamentManager.Models.BowlerSquadScore(198, 198, 198)
        {
            SquadId = squad.Id,
            Division = division1,
            Bowler = new TournamentManager.Models.Bowler { Name = new TournamentManager.Models.PersonName { First = "division1CasherScore2" } }
        };

        var division1NonQualifierScore1 = new TournamentManager.Models.BowlerSquadScore(197, 197, 197)
        {
            SquadId = squad.Id,
            Division = division1,
            Bowler = new TournamentManager.Models.Bowler { Name = new TournamentManager.Models.PersonName { First = "division1NonQualifierScore1" } }
        };

        var division1NonQualifierScore2 = new TournamentManager.Models.BowlerSquadScore(196, 196, 196)
        {
            SquadId = squad.Id,
            Division = division1,
            Bowler = new TournamentManager.Models.Bowler
            {
                Name = new TournamentManager.Models.PersonName { First = "division1NonQualifierScore2" }
            }
        };

        var division1NonQualifierScore3 = new TournamentManager.Models.BowlerSquadScore(195, 195, 195)
        {
            SquadId = squad.Id,
            Division = division1,
            Bowler = new TournamentManager.Models.Bowler
            {
                Name = new TournamentManager.Models.PersonName { First = "division1NonQualifierScore3" }
            }
        };

        var division2AdvancerScore = new TournamentManager.Models.BowlerSquadScore(200, 200, 200)
        {
            SquadId = squad.Id,
            Division = division2,
            Bowler = new TournamentManager.Models.Bowler
            {
                Name = new TournamentManager.Models.PersonName { First = "division2AdvancerScore" }
            }
        };

        var division2CasherScore1 = new TournamentManager.Models.BowlerSquadScore(199, 199, 199)
        {
            SquadId = squad.Id,
            Division = division2,
            Bowler = new TournamentManager.Models.Bowler
            {
                Name = new TournamentManager.Models.PersonName { First = "division2CasherScore1" }
            }
        };

        var division2CasherScore2 = new TournamentManager.Models.BowlerSquadScore(198, 198, 198)
        {
            SquadId = squad.Id,
            Division = division2,
            Bowler = new TournamentManager.Models.Bowler
            {
                Name = new TournamentManager.Models.PersonName { First = "division2CasherScore2" }
            }
        };

        var division2NonQualifierScore1 = new TournamentManager.Models.BowlerSquadScore(197, 197, 197)
        {
            SquadId = squad.Id,
            Division = division2,
            Bowler = new TournamentManager.Models.Bowler { Name = new TournamentManager.Models.PersonName { First = "division2NonQualifierScore1" } }
        };

        var division2NonQualifierScore2 = new TournamentManager.Models.BowlerSquadScore(196, 196, 196)
        {
            SquadId = squad.Id,
            Division = division2,
            Bowler = new TournamentManager.Models.Bowler { Name = new TournamentManager.Models.PersonName { First = "division2NonQualifierScore2" } }
        };

        var division2NonQualifierScore3 = new TournamentManager.Models.BowlerSquadScore(195, 195, 195)
        {
            SquadId = squad.Id,
            Division = division2,
            Bowler = new TournamentManager.Models.Bowler { Name = new TournamentManager.Models.PersonName { First = "division2NonQualifierScore3" } }
        };

        var division1Result = new TournamentManager.Models.SquadResult
        {
        ...
        var division2Result = new TournamentManager.Models.SquadResult
        {
