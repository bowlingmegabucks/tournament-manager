...
{
    private Mock<TournamentManager.Registrations.Retrieve.ITournamentRegistrationsView> _view;
    private Mock<TournamentManager.Registrations.Retrieve.IAdapter> _registrationsAdapter;
    ...
    private Mock<TournamentManager.Registrations.Update.IAdapter> _updateRegistrationAdapter;

    private TournamentManager.Registrations.Retrieve.TournamentRegistrationsPresenter _presenter;

    [SetUp]
    public void SetUp()
    {
        _view = new Mock<TournamentManager.Registrations.Retrieve.ITournamentRegistrationsView>();
        _registrationsAdapter = new Mock<TournamentManager.Registrations.Retrieve.IAdapter>();
        ...
        _updateRegistrationAdapter = new Mock<TournamentManager.Registrations.Update.IAdapter>();

        _presenter = new TournamentManager.Registrations.Retrieve.TournamentRegistrationsPresenter(_view.Object, _registrationsAdapter.Object, _squadsAdapter.Object, _sweepersAdapter.Object, _deleteAdapter.Object, _updateRegistrationAdapter.Object);
    }
    ...
    public async Task ExecuteAsync_AllAdaptersHaveDifferentErrors_ErrorDisplayedCorrectly()
    {
        ...
        var error3 = new TournamentManager.Models.ErrorDetail("error3");
    ...
    public async Task ExecuteAsync_AdaperCallHasError_ErrorFlow()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            _view.Verify(view => view.BindRegistrations(It.IsAny<IEnumerable<TournamentManager.Registrations.Retrieve.ITournamentRegistrationViewModel>>()), Times.Never);
    ...
    {
        var registrations = new List<TournamentManager.Registrations.Retrieve.ITournamentRegistrationViewModel>
        {
            new TournamentManager.Registrations.Retrieve.TournamentRegistrationViewModel
            {
                FirstName = "Joe",
                LastName = "Bowler"
            },
        ...
        Assert.Multiple(() =>
        {
            _view.Verify(view => view.BindRegistrations(It.Is<IEnumerable<TournamentManager.Registrations.Retrieve.ITournamentRegistrationViewModel>>(r => r.First().FirstName == "John")), Times.Once);
            _view.Verify(view => view.BindRegistrations(It.Is<IEnumerable<TournamentManager.Registrations.Retrieve.ITournamentRegistrationViewModel>>(r => r.Last().FirstName == "Joe")), Times.Once);
            _view.Verify(view => view.BindRegistrations(It.Is<IEnumerable<TournamentManager.Registrations.Retrieve.ITournamentRegistrationViewModel>>(r => r.ToList()[1].FirstName == "Jane")), Times.Once);
        });
    }
    ...
    {
        var registration1 = new Mock<TournamentManager.Registrations.Retrieve.ITournamentRegistrationViewModel>();
        ...
        var registration2 = new Mock<TournamentManager.Registrations.Retrieve.ITournamentRegistrationViewModel>();
        ...
        var registration3 = new Mock<TournamentManager.Registrations.Retrieve.ITournamentRegistrationViewModel>();
