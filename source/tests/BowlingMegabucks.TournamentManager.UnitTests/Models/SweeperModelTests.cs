...
internal sealed class Sweeper
{
    ...
    {
        var sweeperDivision1 = new TournamentManager.Database.Entities.SweeperDivision
        {
        ...
        var sweeperDivision2 = new TournamentManager.Database.Entities.SweeperDivision
        {
            SweeperId = SquadId.New(),
            DivisionId = DivisionId.New(),
            BonusPinsPerGame = 2
        ...
        var sweeperDivisions = new List<TournamentManager.Database.Entities.SweeperDivision>
        {
            sweeperDivision1,
            sweeperDivision2
        };
        ...
        var model = new TournamentManager.Models.Sweeper(entity);
