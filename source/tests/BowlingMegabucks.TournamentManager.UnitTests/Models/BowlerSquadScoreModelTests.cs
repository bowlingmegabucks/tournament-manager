...
internal sealed class BowlerSquadScore
{
    ...
    public void Constructor_IGroupingBowlerModelSquadScoreModel_BowlerMapped()
    {
        ...
        var squadScore1 = new TournamentManager.Models.SquadScore
        {
            Bowler = bowler,
            SquadId = SquadId.New(),
            GameNumber = 1,
        ...
        var squadScore2 = new TournamentManager.Models.SquadScore
        {
            Bowler = bowler,
            SquadId = SquadId.New(),
            GameNumber = 2,
        ...
        var squadScore3 = new TournamentManager.Models.SquadScore
        {
            Bowler = bowler,
            SquadId = SquadId.New(),
            GameNumber = 3,
        ...
        var bowlerSquadScore = new TournamentManager.Models.BowlerSquadScore(squadScores.GroupBy(squadScore => squadScore.Bowler).Single());
    ...
    {
        var bowlerSquadScore = new TournamentManager.Models.BowlerSquadScore();
...
#pragma warning restore CA1508 // Avoid dead conditional code
    ...
    public void Equals_ObjNotBowlerSquadScore_ReturnsFalse()
    {
        ...
        Assert.That(bowlerSquadScore.Equals(new TournamentManager.Models.LaneAssignment()), Is.False);
    }
    ...
    public void Equals_ObjBowlerSquadScore_DifferentBowlers_ReturnsFalse()
    {
        ...
        var other = new TournamentManager.Models.BowlerSquadScore();
        bowlerSquadScore.Bowler.Id = BowlerId.New();
    ...
    {
        var bowlerSquadScore = new TournamentManager.Models.BowlerSquadScore(200, 201)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };

        var other = new TournamentManager.Models.BowlerSquadScore(200, 201, 202)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() },
        };
    ...
    public void CompareTo_OtherHasLessGames_ReturnsNegative1()
    {
        ...
        var other = new TournamentManager.Models.BowlerSquadScore(200)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };
    ...
    {
        var bowlerSquadScore = new TournamentManager.Models.BowlerSquadScore(200, 201, 202)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() },
        };

        var other = new TournamentManager.Models.BowlerSquadScore(200, 201, 203)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };
    ...
    public void CompareTo_SameTotalGames_OtherHasLowerScore_ReturnsNegative1()
    {
        ...
        var other = new TournamentManager.Models.BowlerSquadScore(200, 201, 200)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };
    ...
    public void CompareTo_SameTotalGames_SameTotalScore_OtherHasHigherGame_Returns1()
    {
        ...
        var other = new TournamentManager.Models.BowlerSquadScore(200, 201, 199)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };
    ...
    {
        var bowlerSquadScore = new TournamentManager.Models.BowlerSquadScore(200, 199, 201)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };

        var other = new TournamentManager.Models.BowlerSquadScore(200, 200, 200)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };
    ...
    {
        var bowlerSquadScore = new TournamentManager.Models.BowlerSquadScore(200, 200, 200, 300)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };

        var other = new TournamentManager.Models.BowlerSquadScore(200, 199, 201, 300)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };
    ...
    public void CompareTo_SameTotalGames_SameTotalScore_SameHighGame_Other2ndHighIsLower_ReturnsNegative1()
    {
        ...
        var other = new TournamentManager.Models.BowlerSquadScore(200, 201, 199, 300)
        {
            Bowler = new TournamentManager.Models.Bowler { Id = BowlerId.New() }
        };
