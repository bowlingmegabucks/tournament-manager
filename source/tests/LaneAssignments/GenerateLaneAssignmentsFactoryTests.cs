...
internal class GenerateFactory
{
    ...
    {
        var instance = new NortheastMegabuck.LaneAssignments.GenerateFactory().Execute(true);
    ...
    {
        var instance = new NortheastMegabuck.LaneAssignments.GenerateFactory().Execute(false);
